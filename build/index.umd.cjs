(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('three/examples/jsm/postprocessing/Pass.js'), require('three-mesh-bvh'), require('three/examples/jsm/utils/BufferGeometryUtils.js'), require('three-mesh-bvh/src/workers/GenerateMeshBVHWorker.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', 'three/examples/jsm/postprocessing/Pass.js', 'three-mesh-bvh', 'three/examples/jsm/utils/BufferGeometryUtils.js', 'three-mesh-bvh/src/workers/GenerateMeshBVHWorker.js'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ThreePathTracer = global.ThreePathTracer || {}, global.THREE, global.THREE, global.MeshBVHLib, global.THREE, global.MeshBVHLib));
})(this, (function (exports, three, Pass_js, threeMeshBvh, BufferGeometryUtils_js, GenerateMeshBVHWorker_js) { 'use strict';
...
`;
	...
	exports.AttributesTextureArray = AttributesTextureArray;
